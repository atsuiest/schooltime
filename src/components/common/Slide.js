    ...
    return (
      <div class="mb-40">
        <div
          ...
          class="carousel slide carousel-fade pb-10"
          data-ride="carousel"
          ...
          <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
              ...
              <div class="carousel-caption">
                <h3 class="h3-responsive">Corporativa</h3>
                {/* <p>First text</p> */}
              </div>
            </div>
            <div class="carousel-item">
              ...
              <div class="carousel-caption">
                <h3 class="h3-responsive">Institucional</h3>
                {/* <p>Secondary text</p> */}
              </div>
            </div>
            <div class="carousel-item">
              ...
              <div class="carousel-caption">
                <h3 class="h3-responsive">Colegios</h3>
                {/* <p>Third text</p> */}
              </div>
            </div>
          </div>
